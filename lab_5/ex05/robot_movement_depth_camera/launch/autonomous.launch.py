...
def generate_launch_description():
    ...
    # Gazebo launch (запускает измененный нами robot_gazebo.launch.py)
    ...
    # Robot state publisher (Публикует TF дерева, включая lidar_link)
    ...
    obstacle_avoider_node = Node(
        package='robot_movement_depth_camera',
